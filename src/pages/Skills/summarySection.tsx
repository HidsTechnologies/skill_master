                ...
                <div className="flex">
                    <div className="grid grid-cols-2 w-full gap-10">
                        ...
                        <div className="flex flex-col gap-y-5 pl-40 w-max">
                            ...
                            <h1 className="text-lg text-gray-600 font-semibold font-mono mt-5">Course Code :</h1>
                            <h1 className="text-lg text-gray-600 font-semibold font-mono">Course Name :</h1>
                            <h1 className="text-lg text-gray-600 font-semibold font-mono">Coordinating Unit :</h1>
                            <h1 className="text-lg text-gray-600 font-semibold font-mono">Term :</h1>
                            <h1 className="text-lg text-gray-600 font-semibold font-mono">Level :</h1>
                            <h1 className="text-lg text-gray-600 font-semibold font-mono">Location/s :</h1>
                            <h1 className="text-lg text-gray-600 font-semibold font-mono">Units :</h1>
                            <h1 className="text-lg text-gray-600 font-semibold font-mono">Qualification :</h1>
                            <h1 className="text-lg text-gray-600 font-semibold font-mono">Assumed Knowledge :</h1>
                            <h1 className="text-lg text-gray-600 font-semibold font-mono">Course Description :</h1>
                            <h1 className="text-lg text-gray-600 font-semibold font-mono">Course Staff :</h1>
                            <h1 className="text-lg text-gray-600 font-semibold font-mono">Course Timetable :</h1>
                        </div>
                    </div>
                </div>
                <div className="flex flex-col">
