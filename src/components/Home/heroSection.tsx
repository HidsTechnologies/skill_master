        ...
        <main>
            <div className="relative w-full h-[85vh]">
                ...
                <div className="absolute flex flex-col w-max mt-80">
                    ...
                    <button className="flex w-max rounded-md bg-blue-700 mt-5 px-5 py-2 md:ml-40 ml-32 hover:bg-blue-600 text-white">Explore Courses <ArrowRightIcon className="w-6"/></button>
                </div>
            </div>
        </main>
    );
